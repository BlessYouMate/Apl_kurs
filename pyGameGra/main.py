...
while running:
    ...
    if end_game is True:
        ...
        if 490 - 45 <= mouse[0] <= 490 - 45 + 100 and 400 <= mouse[1] <= 400 + 35:
            pygame.draw.rect(screen, bg_color, [4190 - 45, 400, 100, 35])
            text = smallfont.render('MENU', True, color2)
    ...
    if start_game is True:
        ...
        if 485 - 45 <= mouse[0] <= 485 - 45 + 80 and 425 <= mouse[1] <= 425 + 35:
            pygame.draw.rect(screen, bg_color, [4190 - 45, 400, 100, 35])
            text = smallfont.render('QUIT', True, color2)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if 450 <= mouse[0] <= 450 + 95 and 400 <= mouse[1] <= 400 + 35 and end_game is True:
                start_game = True
                end_screen = False
                end_game = False
                start_screen = True
            ...
            # QUIT ON START
            if 485 - 45 <= mouse[0] <= 485 - 45 + 80 and 425 <= mouse[1] <= 425 + 35 and start_screen is True\
    ...
    for i in range(num_of_enemies):
        ...
        if enemy_collision:
            death_Sound = mixer.Sound('gong.wav')
